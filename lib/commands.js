    ...
    reschedule: {
      action: async function (data, msg) {
        try {
          ...
          console.log("old meeting date***********\n");
          console.log(data.oldMeetingDate);
          console.log(data.oldMeetingDate[0]);
          console.log("***********\n");
          ...
          console.log("***********\n");
          console.log(data.newMeetingDate);
          console.log(data.newMeetingDate[0]);
          console.log(data.newMeetingDate.length);
          console.log("***********\n");
          ...
          console.log("***********\n");
          console.log(newStartDate.toISO());
          console.log(newEndDate.toISO());
          console.log("***********\n");
