    ...
    reschedule: {
      action: async function (data, msg) {
        try {
          ...
          console.log("*****************\n");
          console.log("newMeetingDate:" + data.newMeetingDate);
          console.log("length:" + data.newMeetingDate.length);
          console.log("index 0:" + data.newMeetingDate[0]);
          console.log("index 1:" + data.newMeetingDate[1]);
          console.log("*****************\n");
