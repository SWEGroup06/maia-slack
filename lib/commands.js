    ...
    sp: {
      ...
      action: async function (data, msg) {
        try {
          ...
          const res = await conn.sp(email, data.title, data.duration, data.people, data.startDateRange,
           data.endDateRange, data.startTimeRange, data.endTimeRange, data.dayOfWeek);
