...
const context = {
  ...
  sp: function(slackEmails, title, duration, startDateRange, endDateRange, startTimeRange, endTimeRange, dayOfWeek) {
    return context._request('/api/sp', {slackEmails, title, duration, startDateRange, endDateRange, startTimeRange, endTimeRange, dayOfWeek});
  },
