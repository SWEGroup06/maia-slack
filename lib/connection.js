...
const context = {
   ...
   * @param {Array} slackEmails - Slack emails of attendees
   * @param {string} startDateTimeOfRange - Start of the DateTime range
   * @param {string} endDateTimeOfRange - End of the DateTime range
   * @param {boolean} flexible - whether the event is flexible or not
   * @param {number} duration - the duration of the event (in minutes)
   * @param {string} beforeAfterKey - if user has stated 'before' or 'after'
   * @return {Promise<any>} - returns a request to the backend API
   */
  schedule: function (
    title,
    slackEmails,
  ...
  /**
   * TODO: Replace with tp
   *
   * @param {string} slackEmail - Unique email relating to Slack account
   * @param {string} startDateTime - remove
   * @param {string} endDateTime - remove
   * @param {string} newStartDateTime - remove
   * @param {string} newEndDateTime - remove
   * @param {string} meetingTitle - remove
   * @param {string} beforeAfterKey - remove
   * @return {Promise<any>} - returns a request to the backend API
   */
  reschedule: function (
    slackEmail,
  ...
  sp: function (
    ...
    return context._request("/api/sp", {
      slackEmails,
      title,
      duration,
      startDateRange,
