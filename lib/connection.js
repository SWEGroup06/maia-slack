...
const context = {
  ...
  tp: function(slackEmail, oldTitle, oldDateTime, newStartDateRange, newEndDateRange, newStartTimeRange, newEndTimeRange, newDayOfWeek, timeRangeSpecified) {
    return context._request('/api/tp', {slackEmail, oldTitle, oldDateTime, newStartDateRange, newEndDateRange, newStartTimeRange, newEndTimeRange, newDayOfWeek, timeRangeSpecified});
  }
}
