...
const context = {
   ...
   * @return {Promise<any>} - API call to the backend
   */
  generatePreferences: function (slackEmail) {
    return context._request("/api/preferences", { slackEmail });
  },

  setMinBreak: function (slackEmail, minBreakLength) {
    return context._request("/api/setMinBreak", { slackEmail, minBreakLength });
  },
  /**
   * TODO:
   *
