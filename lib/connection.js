...
const context = {
  ...
  sp: function(slackEmail, title, duration, people, startDateRange, endDateRange, startTimeRange, endTimeRange, dayOfWeek) {
    return context._request('/api/tp', {slackEmail, title, duration, people, startDateRange, endDateRange, startTimeRange, endTimeRange, dayOfWeek});
  }
}
